...
function SuccessfulDonationComponent() {
    return(
        <div className="successful-donation-container">
            ...
            <h2>Thank you for donating to Community Closet! Your impending donation was successfully record! Please make sure to drop off your donation at one of our partner locations!</h2>
