...
function HomePageMainCard() {
    return (
        <div className='main-card-container mt-3'>
            <img src="https://slpfitimsbybjuojrsga.supabase.co/storage/v1/object/public/Images%20for%20CommunityCloset/assets/free-essentials.jpeg" alt="Woman shopping" className='main-card-img image-border'></img>
