            ...
            <div id="carouselExampleCaptions" className="carousel slide">
                ...
                <div className="carousel-inner image-border">
                    <div className="carousel-item active">
                        <img src="https://slpfitimsbybjuojrsga.supabase.co/storage/v1/object/public/Images%20for%20CommunityCloset/jeans.jpeg" className="d-block w-100 image-border" alt="..." />
                    ...
                    <div className="carousel-item">
                        <img src="https://slpfitimsbybjuojrsga.supabase.co/storage/v1/object/public/Images%20for%20CommunityCloset/sweater.webp" className="d-block w-100 image-border" alt="..." />
                        <div className="carousel-caption d-none d-md-block">
